# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2020-06-15 08:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', sales.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Campuses',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='sales.UserProfile', verbose_name='跟进人')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.UserProfile', verbose_name='讲师')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='sales.UserProfile', verbose_name='销售')),
                ...
                ('network_consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='network_consultant', to='sales.UserProfile', verbose_name='咨询师')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirm_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirms', to='sales.UserProfile', verbose_name='确认人')),
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.UserProfile', verbose_name='销售')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Customer', verbose_name='客户')),
                ('enrolment_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sales.ClassList', verbose_name='所报班级')),
            ],
        ),
        migrations.CreateModel(
            name='StudyRecord',
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sales.ContractTemplate', verbose_name='选择合同模版'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='sales.UserProfile', verbose_name='老师'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='department',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='sales.Department'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
